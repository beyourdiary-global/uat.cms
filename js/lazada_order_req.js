...
$(".submitBtn").on("click", () => {
  ...
  if (
    $("#lor_lazada_acc_hidden").val() === "" ||
    $("#lor_lazada_acc_hidden").val() == "0" ||
    $("#lor_lazada_acc_hidden").val() === null ||
    $("#lor_lazada_acc_hidden").val() === undefined
  ) {
    lazada_acc_chk = 0;
  ...
  if (
    $("#lor_curr_unit_hidden").val() == "" ||
    $("#lor_curr_unit_hidden").val() == "0" ||
    $("#lor_curr_unit_hidden").val() === null ||
    $("#lor_curr_unit_hidden").val() === undefined
  ) {
    curr_unit_chk = 0;
    $("#lor_curr_unit").after(
  ...
  if (
    $("#lor_lzd_country_hidden").val() == "" ||
    $("#lor_lzd_country_hidden").val() == "0" ||
    $("#lor_lzd_country_hidden").val() === null ||
    $("#lor_lzd_country_hidden").val() === undefined
  ) {
    lzd_country_chk = 0;
  ...
  if (
    $("#lor_cust_id_hidden").val() == "" ||
    $("#lor_cust_id_hidden").val() == "0" ||
    $("#lor_cust_id_hidden").val() === null ||
    $("#lor_cust_id_hidden").val() === undefined
  ) {
    cust_id_chk = 0;
    $("#lor_cust_id").after(
  ...
  if (
    $("#lor_cust_name").val() == "" ||
    $("#lor_cust_name").val() == "0" ||
    $("#lor_cust_name").val() === null ||
    $("#lor_cust_name").val() === undefined
  ) {
    cust_name_chk = 0;
    $("#lor_cust_name").after(
  ...
  //   if (
  //     $("#lor_cust_email").val() == "0" ||
  //     $("#lor_cust_email").val() === null ||
  //     $("#lor_cust_email").val() === undefined
  //   ) {
  //     cust_email_chk = 0;
  ...
  //   if (
  //     $("#lor_cust_phone").val() == "" ||
  //     $("#lor_cust_phone").val() == "0" ||
  //     $("#lor_cust_phone").val() === null ||
  //     $("#lor_cust_phone").val() === undefined
  //   ) {
  //     cust_phone_chk = 0;
  ...
  if (
    $("#lor_country_hidden").val() == "" ||
    $("#lor_country_hidden").val() == "0" ||
    $("#lor_country_hidden").val() === null ||
    $("#lor_country_hidden").val() === undefined
  ) {
    country_chk = 0;
    $("#lor_country").after(
  ...
  if (
    $("#lor_oder_number").val() == "" ||
    $("#lor_oder_number").val() == "0" ||
    $("#lor_oder_number").val() === null ||
    $("#lor_oder_number").val() === undefined
  ) {
    oder_number_chk = 0;
  ...
  if (
    $("#lor_sales_pic").val() == "" ||
    $("#lor_sales_pic").val() == "0" ||
    $("#lor_sales_pic").val() === null ||
    $("#lor_sales_pic").val() === undefined
  ) {
    sales_pic_chk = 0;
    $("#lor_sales_pic").after(
  ...
  if (
    $("#lor_ship_rec_name").val() == "" ||
    $("#lor_ship_rec_name").val() == "0" ||
    $("#lor_ship_rec_name").val() === null ||
    $("#lor_ship_rec_name").val() === undefined
  ) {
    ship_rec_name_chk = 0;
  ...
  if (
    $("#lor_ship_rec_address").val() == "" ||
    $("#lor_ship_rec_address").val() == "0" ||
    $("#lor_ship_rec_address").val() === null ||
    $("#lor_ship_rec_address").val() === undefined
  ) {
  ...
  if (
    $("#lor_ship_rec_contact").val() == "" ||
    $("#lor_ship_rec_contact").val() == "0" ||
    $("#lor_ship_rec_contact").val() === null ||
    $("#lor_ship_rec_contact").val() === undefined
  ) {
  ...
  if (
    $("#lor_brand_hidden").val() == "" ||
    $("#lor_brand_hidden").val() == "0" ||
    $("#lor_brand_hidden").val() === null ||
    $("#lor_brand_hidden").val() === undefined
  ) {
    brand_chk = 0;
    $("#lor_brand").after(
  ...
  if (
    $("#lor_series_hidden").val() == "" ||
    $("#lor_series_hidden").val() == "0" ||
    $("#lor_series_hidden").val() === null ||
    $("#lor_series_hidden").val() === undefined
  ) {
    series_chk = 0;
    $("#lor_series").after(
  ...
  if (
    $("#lor_pkg_hidden").val() == "" ||
    $("#lor_pkg_hidden").val() == "0" ||
    $("#lor_pkg_hidden").val() === null ||
    $("#lor_pkg_hidden").val() === undefined
  ) {
    pkg_chk = 0;
    $("#lor_pkg").after(
  ...
  if (
    $("#lor_item_price_credit").val() == "" ||
    $("#lor_item_price_credit").val() == "0" ||
    $("#lor_item_price_credit").val() === null ||
    $("#lor_item_price_credit").val() === undefined
  ) {
  ...
  if (
    $("#lor_final_income").val() == "" ||
    $("#lor_final_income").val() == "0" ||
    $("#lor_final_income").val() === null ||
    $("#lor_final_income").val() === undefined
  ) {
    final_income_chk = 0;
  ...
  if (
    $("#lor_pay_meth").val() == "" ||
    $("#lor_pay_meth").val() == "0" ||
    $("#lor_pay_meth").val() === null ||
    $("#lor_pay_meth").val() === undefined
  ) {
    pay_meth_chk = 0;
    $("#lor_pay_meth").after(
...
function autofill() {
  ...
  retrieveDBData(paramMrcht, "<?= $SITEURL ?>", function (result) {
    if (result && result.length > 0) {
      var cusName = result[0]["name"];
      var cusEmail = result[0]["email"];
      var cusPhone = result[0]["phone"];
      $("#lor_cust_name").val(cusName);
      $("#lor_cust_email").val(cusEmail);
      $("#lor_cust_phone").val(cusPhone);
    }
  });
}
