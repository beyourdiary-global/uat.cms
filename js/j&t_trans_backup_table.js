...
$(document).ready(function ($) {
    ...
    $('a[name="exportBtn"]').on("click", function () {
        ...
        $('#jt_trans_backup_table').DataTable().$('tr', { "filter": "applied" }).each(function () {
        ...
        if (checkboxValues.length > 0) {
            ...
            window.location.href = "j&t_trans_backup_table.php";
        } else {
    ...
    function updateCheckboxesOnOtherPages(isChecked) {
        ...
        var cells = $('#jt_trans_backup_table').DataTable().cells().nodes();
