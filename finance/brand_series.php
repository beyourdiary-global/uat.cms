        ...
        case 'updData':
            ...
            if ($action == 'addData') {
                try {
                    ...
                    if (isset($row['brand']) && $row['brand'] != $brand) {
                ...
                try {
                    if (isset($row['name']) && $row['name'] != $currentDataName) {
                    ...
                    if (isset($row['remark']) && $row['remark'] != $dataRemark) {
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label form" for="currentDataName"><?php echo $pageTitle ?>
                                    Name</label>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group autocomplete mb-3">
                                <label class="form-label form" id="brand" for="brand">Brand</label><?php
                                if (isset($row['brand'])) {
                                    $brand_result = getData('name', "id = '{$row['brand']}'", '', BRAND, $connect);
                                     if ($brand_result && $brand_row = $brand_result->fetch_assoc()) {
                                        $echoVal = $brand_row['name'];
                                    }
                                }
                                ?>
                                <input class="form-control" type="text" name="brand" id="brand"
                                value="<?php echo !empty($echoVal) ? $echoVal : ''; ?>"
                                ...
                                <div id="err_msg"><span class="mt-n1"><?php 
                                if (isset($brand_err)) echo $brand_err; ?></span>
                            </div>
                        </div>
                    </div>
