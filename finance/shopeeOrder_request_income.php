...
$result = getData("$groupbyValue, $groupbyValue2, SUM(price) as price, id,  GROUP_CONCAT(id) AS combined_ids ", $sqlQuery . ' GROUP BY ' . $groupbyValue . " ," . $groupbyValue2, '', SHOPEE_SG_ORDER_REQ, $finance_connect);
