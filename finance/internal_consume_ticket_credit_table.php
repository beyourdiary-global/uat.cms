...
if (!empty($checkboxValues)) {
    ...
    if ($query2->num_rows > 0) {
        while ($row2 = $query2->fetch_assoc()) {
            ...
            $columnNames = array('PIC', 'brand', 'currency_unit', 'amount','remark','attachment','create_by', 'create_date', 'create_time', 'update_by', 'update_date', 'update_time');
    ...
    <div id="dispTable" class="container-fluid d-flex justify-content-center mt-3">
        ...
        <div class="col-12 col-md-11">
            ...
            <div class="row mb-3">
                    ...
                    <a id='resetButton' href="../reset.php?redirect=finance/internal_consume_ticket_credit_table.php" class="btn btn-sm btn-rounded btn-primary"> <i class="fa fa-refresh"></i> Reset </a>
                    </div>
                </div>
                        ...
                        while ($row = $result->fetch_assoc()) {    
                           ...
                           if (isset($row['id']) && !empty($row['id'])) {
                            ...
                            if ($groupOption == '') {
                                ...
                                <td scope="row">' . (isset($brandRow['name']) ? $brandRow['name'] : '') . '</td>
                            ...
                            if ($groupOption && $groupOption3) {
                                if (($groupOption === 'person' || $groupOption === 'brand' || $groupOption === 'currency') && $groupOption4 === 'daily') {
                                    $key = $groupOption === 'person' ? $person : ($groupOption === 'brand' ? $brand : $curr);
                                ...
                                else if (($groupOption === 'person' || $groupOption === 'brand' || $groupOption === 'currency') && $groupOption4 !== 'daily') {
                            ...
                            foreach ($groupedRows as $key => $groupedRow) {
                                ...
                                $url = $groupOption4 == 'daily' ? "internal_consume_ticket_credit_table_detail.php?ids=" . urlencode($ids) : "internal_consume_ticket_credit_table_summary.php?ids=" . urlencode($ids);
