                        ...
                        ?>
                                ...
                                <th class="hideColumn" scope="row"><?= $row['id'] ?></th>
                                    ...
                                    <td scope="row" class="btn-container">
                                        ...
                                        <a class="btn btn-danger" onclick="confirmationDialog('<?= $row['id'] ?>',['<?= $row['commission'] ?>','<?= $row['service'] ?>'],'<?php echo $pageTitle ?>','<?= $redirect_page ?>','<?= $deleteRedirectPage ?>','D')"><i class="fas fa-trash-alt"></i></a>
                                        <?php endif; ?>
                                        </td>
