...
<div class="pre-load-center">
    ...
    <div class="page-load-cover">
        <div id="dispTable" class="container-fluid d-flex justify-content-center mt-3">
                    ...
                    <div class="col-12 d-flex justify-content-between flex-wrap">
                        ...
                        <div class="mt-auto mb-auto">
                            <?php if (isActionAllowed("Add", $pinAccess)) : ?>
                                <a class="btn btn-sm btn-rounded btn-primary" name="addBtn" id="addBtn" href="<?= $redirect_page . "?act=" . $act_1 ?>"><i class="fa-solid fa-plus"></i> Add Payment Method </a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <table class="table table-striped" id="payment_method_shopee_table">
                <thead>
                    <tr>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td scope="row" class="btn-container">
                                        ...
                                        <a class="btn btn-danger" onclick="confirmationDialog('<?= $row['id'] ?>',['<?= $row['name'] ?>','<?= $row['fees'] ?>'],'<?php echo $pageTitle ?>','<?= $redirect_page ?>','<?= $deleteRedirectPage ?>','D')"><i class="fas fa-trash-alt"></i></a>
                                        <?php endif; ?>
                                        </td>
                                <td scope="row"><?= isset($row['name']) ? $row['name']  : '' ?></td>
                                <td scope="row"><?= isset($row['fees']) ? $row['fees'] : '' ?></td>
...
*/
    ...
    */
    datatableAlignment('payment_method_shopee_table');
    setButtonColor();
</script>
