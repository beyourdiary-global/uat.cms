    ...
    switch ($action) {
        ...
        case 'updTransaction':
            ...
            if (!$jt_inv_number) {
                ...
                break;
            } else if ($jt_inv_number && $jt_inv_date && isDuplicateRecordWithConditions(['number', 'date'], [$jt_inv_number, $jt_inv_date], $tblName, $finance_connect, $dataID)) {
                ...
                try {
                    ...
                    $query = "INSERT INTO " . $tblName  . "(number,date,attachment,create_by,create_date,create_time) VALUES ('$jt_inv_number','$jt_inv_date','$jt_attach','" . USER_ID . "',curdate(),curtime())";
                    // Execute the query
                ...
                try {
                    ...
                    if (count($oldvalarr) > 0 && count($chgvalarr) > 0) {
                        $query = "UPDATE " . $tblName  . " SET number = '$jt_inv_number', date = '$jt_inv_date', attachment ='$jt_attach', update_date = curdate(), update_time = curtime(), update_by ='" . USER_ID . "' WHERE id = '$dataID'";
                        $returnData = mysqli_query($finance_connect, $query);
                    } else {
                        $act = 'NC';
                    }
...
<body>
    ...
    <div id="formContainer" class="container d-flex justify-content-center">
        ...
        <div class="form-group mb-3">
            ...
            <input class="form-control" type="number" name="jt_inv_number" id="jt_inv_number" value="<?php
