        ...
        <div class="col-6 col-md-6 formWidthAdjust">
            <form id="IVTRForm" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="invtr_mrcht" name="invtr_mrcht" <?php if ($act == '') echo 'disabled' ?>>
                                <option value="0" disabled selected>Select Merchant</option>
                                <option value="other" <?php if (isset($invtr_mrcht) && $invtr_mrcht == 'other') echo 'selected'; ?>>Create
                                    New Merchant</option>
                                <?php
                ...
                <div class="form-group mb-3">
                    <div class="row">
                        <div class="col-md-6">
                            <label class="form-label form_lbl" id="invtr_mrcht_lbl" for="invtr_item">Item<span class="requireRed">*</span></label>
