...
$total = 0;
$currentpageRedirect = SITEURL . "/finance/lazadaOrder_request_income.php";
$detailPage = SITEURL . "/lazada_order_req_table.php";
                ...
                <table class="table table-striped" id="shopee_order_req_table">
                        ...
                        <tr>
                            ...
                            <?php if (input('group')): ?>
                                <th id="group_header" scope="col">
                                    <?= getGroupHeader(input('group')); ?>
                                </th>
                            <?php endif; ?>

                            <?php if (input('group2')): ?>
                                <th id="group_header" scope="col">
                                    <?= getGroupHeader(input('group2')); ?>
                                </th>
                            <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo $groupbyValue2 ? '<td scope="row">' . convertDbNaming($groupbyValue2, $row[$groupbyValue2]) . '
                        </td>' : '';

                            $price = !empty($row['item_price_credit']) ? (float) $row['item_price_credit'] : 0;
                            echo '<td scope="row">' . $row['item_price_credit'] . '</td>';
