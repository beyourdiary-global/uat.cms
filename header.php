...
<link href="<?= $SITEURL ?>/header/MaterialDesign-Webfont-master/css/materialdesignicons.css" rel="stylesheet">

<!-- jQuery -->
<script src="<?= $SITEURL ?>/header/js/jquery_1.11.1_jquery.min.js"></script>
