<?php
$pageTitle = "Identify Type";
include 'menuHeader.php';

$identify_type_id = input('id');
$act = input('act');
$redirect_page = $SITEURL . '/identify_type_table.php';

// to display data to input
if($identify_type_id)
{
    $rst = getData('*',"id = '$identify_type_id'",DEPT,$connect);
...
<div class="d-flex flex-column my-3 ms-3">
    <p><a href="<?= $redirect_page ?>">Identify Type</a> <i class="fa-solid fa-chevron-right fa-xs"></i> <?php
    switch($act)
    {
        case 'I': echo 'Add Identify Type'; break;
        case 'E': echo 'Edit Identify Type'; break;
        default: echo 'View Identify Type';
    }
    ?></p>
</div>
    ...
    <div class="col-6 col-md-6 formWidthAdjust">
        <form id="deptForm" method="post" action="">
            ...
            <div class="form-group mb-3">
                <label class="form-label" id="dept_name_lbl" for="dept_name">Identify Type Name</label>
