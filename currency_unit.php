...
if (post('actionBtn')) {
    ...
    switch ($action) {
        ...
        case 'updCurUnit':
            ...
            if (!$cur_unit) {
                $err = "Currency unit cannot be empty.";
                break;
            } else if (isDuplicateRecord("unit", $cur_unit, $tblname, $connect, $cur_unit_id)) {
                $err = "Duplicate record found for currency unit.";
                break;
            } else if ($action == 'addCurUnit') {
                try {
...
<body>
    ...
    <div class="d-flex flex-column my-3 ms-3">
        <p><a href="<?= $redirect_page ?>">Currency Unit</a> <i class="fa-solid fa-chevron-right fa-xs"></i>
            <?php
            switch ($act) {
                case 'I':
                    echo 'Add Currency Unit';
                    break;
                case 'E':
                    echo 'Edit Currency Unit';
                    break;
                default:
                    echo 'View Currency Unit';
            }
            ?></p>
    </div>
