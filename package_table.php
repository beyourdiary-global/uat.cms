...
<script>
$( document ).ready(() => {
    createSortingTable('package_table');
}); 
</script>
...
<div id="dispTable" class="container-fluid d-flex justify-content-center mt-3">
        ...
        <div class="col-12 col-md-8">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between mb-3">
                <div class="left">
                        <h2>Package</h2>
                        <p><a href="dashboard.php">Dashboard</a> <i class="fa-solid fa-slash fa-rotate-90 fa-2xs"></i> Package</p>
                </div>

                <div class="right d-flex">
                    <div class="mt-auto mb-auto">
                        <a class="btn btn-sm btn-rounded btn-primary" name="addBtn" id="addBtn" href="<?= $redirect_page."?act=".$act_1?>"><i class="fa-solid fa-plus"></i> Add Package </a>
                    </div>
                </div>
            </div>
...
$(window).resize(() => {
    datatableAlignment('package_table');
});
