...
<div id="dispTable" class="container-fluid d-flex justify-content-center mt-3">
        ...
        <div class="col-12 col-md-8">
            ...
            <div class="d-flex flex-column mb-3">
                <div class="row">
                    <p><a href="<?= $SITEURL ?>/dashboard.php">Dashboard</a> <i class="fa-solid fa-chevron-right fa-xs"></i> Employment Type Status</p>
                </div>
                    ...
                    <tr>
                        ...
                        <div class="dropdown" style="text-align:center">
                            ...
                            <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="actionDropdownMenu">
                                ...
                                <li>
                                <a class="dropdown-item" onclick="confirmationDialog('<?= $row['id']?>',['<?= $row['name'] ?>','<?= $row['remark'] ?>'],'Employment Type Status','<?= $redirect_page ?>','<?= $SITEURL ?>/em_type_status_table.php','D')">Delete</a>
                                </li>
                            </ul>
                            </div>
                        </td>
