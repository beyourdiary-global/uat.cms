...
function getCountryTelCode($param)
{
	switch ($param) {
		...
		case 'et':		//	Ethiopia
			...
			break;
		case 'FK':
		case 'fk':		//	Falkland Island (Malvinas)
			return '+500';
			break;
		case 'FO':
		...
		case 'rw':		//	Rwanda
			...
			break;
		case 'MP':
		case 'mp':		//	Saipan // Northern Mariana Islands
			return '+1670';
			break;
		case 'WS':
		case 'ws':		//	Samoa
		...
		case 'so':		//	Somalia
			...
			break;
		case 'XS':
		case 'xs':		//	Somaliland (North Somalia)
			return '+252';
			break;
		case 'ZA':
