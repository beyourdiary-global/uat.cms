...
<div class="container-fluid d-flex justify-content-center mt-3">
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
            ...
            <div class="d-flex justify-content-between">
                <div class="left">
                        <h2>Pin Group</h2>
                        <p><a href="dashboard.php">Dashboard</a> <i class="bi bi-slash-lg"></i> Pin Group</p>
                </div>

                <div class="right d-flex">
                    <div class="mt-auto mb-auto">
                        <a class="btn btn-sm btn-rounded btn-primary" name="addPinBtn" id="addPinBtn" href="pin_group.php?act=<?php echo $act_1?>"><i class="bi bi-plus"></i> Add Pin Group </a>
                    </div>
                </div>
            </div>
