...
$redirect_page = $SITEURL . '/employee_epf_rate.php';
...
<script>
    $(document).ready(() => {
        ...
        */
        createSortingTable('employee_epf_rate_table');
    });
</script>
...
<body>
    ...
    <div id="dispTable" class="container-fluid d-flex justify-content-center mt-3">
        ...
        <div class="col-12 col-md-8">
            ...
            <table class="table table-striped" id="employee_epf_rate_table">
                <thead>
                    <tr>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="actionDropdownMenu">
                                        ...
                                        <li>
                                            <?php if (isActionAllowed("Delete", $pinAccess)) : ?>
                                                <a class="dropdown-item" onclick="confirmationDialog('<?= $row['id'] ?>',['<?= $row['epf_rate'] ?>','<?= $row['remark'] ?>'],'<?php echo $pageTitle ?>','<?= $redirect_page ?>','<?= $SITEURL ?>/employee_epf_rate_table.php','D')">Delete</a>
                                            <?php endif; ?>
                                        </li>
                                    </ul>
                                </div>
...
*/
    ...
    */
    datatableAlignment('employee_epf_rate_table');
</script>
