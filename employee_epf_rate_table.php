...
$deleteRedirectPage = $SITEURL . '/employee_epf_rate_table.php';
                ...
                <table class="table table-striped" id="table">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            if (isset($row['epf_rate'], $row['id']) && !empty($row['epf_rate'])) { ?>
                                <tr>
                                    ...
                                    <td scope="row" class="btn-container">
                                        ...
                                        <a class="btn btn-danger" onclick="confirmationDialog('<?= $row['id'] ?>',['<?= $row['epf_rate'] ?>','<?= $row['remark'] ?>'],'<?php echo $pageTitle ?>','<?= $redirect_page ?>','<?= $deleteRedirectPage ?>','D')"><i class="fas fa-trash-alt"></i></a>
                                        <?php endif; ?>
                                        </td>
