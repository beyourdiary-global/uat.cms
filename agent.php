...
$redirect_page = $SITEURL . '/agent_table.php';
...
if (post('actionBtn')) {
    ...
    switch ($action) {
        ...
        case 'updData':
            ...
            $country = postSpaceFilter('country_hidden');
            ...
            if ($action == 'addData') {
                try {
                    ...
                    if ($agt_pic) {
                        ...
                        array_push($datafield, 'person_in_charge');
                    }
                    ...
                    $query = "INSERT INTO " . $tblName . "(name,brand,person_in_charge,contact,email,country,remark,create_by,create_date,create_time) VALUES ('$currentDataName','$brand','$agt_pic', '$contact','$email','$country','$dataRemark','" . USER_ID . "',curdate(),curtime())";
                ...
                try {
                    ...
                    if ($row['person_in_charge'] != $agt_pic) {
                        array_push($oldvalarr, $row['person_in_charge']);
                    ...
                    if ($oldvalarr && $chgvalarr) {
                        $query = "UPDATE " . $tblName . " SET name ='$currentDataName',brand='$brand',person_in_charge='$agt_pic',contact='$contact',email ='$email', country ='$country', remark ='$dataRemark', update_date = curdate(), update_time = curtime(), update_by ='" . USER_ID . "' WHERE id = '$dataID'";
                        $returnData = mysqli_query($connect, $query);
                    } else {
                        $act = 'NC';
                    }
...
<body>
    ...
    <div class="col-12 col-md-6">
        <div class="form-group mb-3 autocomplete">
            ...
            ?>
            <input class="form-control" type="text" name="agt_pic" id="agt_pic" <?php if ($act == '') echo 'readonly' ?> required>
...
<div class="row">
    ...
    <div class="col-12 col-md-6">
        <div class="form-group autocomplete mb-3">
            ...
            if (isset($echoVal)) {
                $country_result = getData('unit', "id = '$echoVal'", '', COUNTRIES, $connect);

                $country_row = $country_result->fetch_assoc();
            }
            ?>
            <input class="form-control" type="text" name="country" id="country" value="<?php echo !empty($echoVal) ? $country_row['unit'] : ''  ?>" <?php if ($act == '') echo 'readonly' ?> required>
            ...
            <div id="err_msg">
                <span class="mt-n1"><?php if (isset($country_err)) echo $country_err; ?></span>
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label form_lbl" for="currentDataRemark_form_lbl"><?php echo $pageTitle ?> Remark</label>
