...
$redirect_page = 'marital_status.php';
                        ...
                        <tr>
                            ...
                            <div class="dropdown" style="text-align:center">
                                ...
                                <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="actionDropdownMenu">
                                    ...
                                    <li>
                                    <a class="dropdown-item" onclick="confirmationDialog('<?= $row['id']?>',['<?= $row['name'] ?>','<?= $row['remark'] ?>'],'Marital Status','<?= $redirect_page ?>','marital_status_table.php','D')">Delete</a>
                                    </li>
                                </ul>
                                </div>
                            </td>
