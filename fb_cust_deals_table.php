...
$reg_member_page = $SITEURL . '/urb_cust_reg_page.php';
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()) { 
                        ...
                        <tr>
                            ...
                            <td scope="row"><?= $row['ship_rec_add']?></td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="actionDropdownMenu">
                                        ...
                                        <li>
                                            <?php if (isActionAllowed("Delete", $pinAccess)) : ?>
                                                <a class="dropdown-item" onclick="confirmationDialog('<?= $row['id'] ?>',['<?= $row['name'] ?>','<?= $row['contact'] ?>'],'<?= $pageTitle ?>','<?= $redirect_page ?>','<?= $SITEURL ?>/fb_cust_deals_table.php','D')">Delete</a>
                                            <?php endif; ?>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="<?=  $reg_member_page . "?id=" . $row['id'] ?>">Urbanism Member</a>
